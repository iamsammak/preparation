...
Pick a couple more of these built-in functions and evaluate their time complexity in a similar way.

## The Project

This project will have you build a "static" array in Ruby, then a dynamic array and a ring buffer. Refer to this reading for the concepts behind the methods you're asked to build, and refer to the specs for guidelines on what each method should do as well. Sally forth!  
